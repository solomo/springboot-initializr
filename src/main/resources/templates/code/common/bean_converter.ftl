...
import ${packageName}.modelmapper.jdk8.Jdk8Module;
import ${packageName}.modelmapper.jsr310.Jsr310Module;
import ${packageName}.modelmapper.jsr310.Jsr310ModuleConfig;
...
public class BeanConverter {
  ...
  static {
    ...
    Jsr310ModuleConfig config = Jsr310ModuleConfig.builder()
        ...
        .build();
    modelMapper.registerModule(new Jsr310Module(config)).registerModule((Module) new Jdk8Module());
